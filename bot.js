...
client.on('message', message => {
  ...
  if (message.author.id !== "543211624027258880") return;
...
client.on("message", message => {
    if (message.content === (prefix + "help")) {
     const embed = new Discord.RichEmbed() 
         ...
         .setDescription(`***C__a__t__a__L__o__n__i__a__ S__y__s__t__h__e__m__*** :closed_lock_with_key: 
اوامر ادارية :gem:
Broadcast
_bc1 = برودكاست لجميع اعضاء السيرفر بايمبد
_bc2 = برودكاست لجميع اعضاء لسيرفر بدون امبد
_bc3 = برودكاست للاونلاين فقط
Other**
_ban {user} = حظر العضو من السيرفر
_kick {user} = طرد العضو من السيرفر
_clear {number} = مسح الشات
اوامر عمومية :gear: 
_id عرض ملفك الشخصي
...
client.login('NTkxOTI1MTA1MjAyODIzMTk5.XQ33ag.5JVHQwflia7Kw62W03SrIvXG18g');
